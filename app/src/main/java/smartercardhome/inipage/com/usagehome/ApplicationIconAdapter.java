...
public class ApplicationIconAdapter extends
    ...
    public ApplicationIconAdapter(List<ApplicationIcon> apps, Context context, Map<ApplicationIcon, Drawable> drawableMap) {
        this.apps = apps;
        this.ctx = context;
    ...
    public void onBindViewHolder(AppIconHolder viewHolder, int i) {
        ...
        viewHolder.mainView.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                View.DragShadowBuilder dsb = new View.DragShadowBuilder();
